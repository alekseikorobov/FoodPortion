...
export const inner_param: IParams = {
    ...
    portion_bzu: "1:1:4",
    products: [
        {id: 1,name: 'Тушенка говяж.',proteins: 17,fats: 18,carbohydrates: 0,calories100g: 230,onePortionG: 70, isMain:true,types:'о,y'},
        {id: 2,name: 'Тушенка свин.',proteins: 15,fats: 35,carbohydrates: 0,calories100g: 380,onePortionG: 70, isMain:true,types:'о,y'},
        {id: 3,name: 'Мясо сублим.',proteins: 60,fats: 40,carbohydrates: 0,calories100g: 600,onePortionG: 30, isMain:true,types:'о,y'},
        ...
        {id: 6,name: 'Суп конц. с мяс',proteins: 8,fats: 15,carbohydrates: 40,calories100g: 335,onePortionG: 40, isMain:true,types:'о,y'},
        ...
        {id: 14,name: 'Масло подсолн.',proteins: 0,fats: 99.9,carbohydrates: 0,calories100g: 900,onePortionG: 22, isMain:true,types:'з,о,y,п'},
        {id: 15,name: 'Сало свинное',proteins: 1.8,fats: 80,carbohydrates: 0,calories100g: 770,onePortionG: 60, isMain:true,types:'з,о,y,п'},
        ...
        {id: 19,name: 'Макароны',proteins: 10,fats: 1,carbohydrates: 75,calories100g: 360,onePortionG: 90, isMain:true,types:'о,y'},
        {id: 20,name: 'Рис',proteins: 8,fats: 0,carbohydrates: 78,calories100g: 350,onePortionG: 70, isMain:true,types:'о,y'},
        {id: 21,name: 'Гречка',proteins: 13,fats: 2,carbohydrates: 68,calories100g: 330,onePortionG: 75, isMain:true,types:'о,y'},
        ...
        {id: 25,name: 'Картоф. пюре',proteins: 6.1,fats: 0,carbohydrates: 72.3,calories100g: 315,onePortionG: 60, isMain:true,types:'о,y'},
        {id: 26,name: 'Грибы свежие',proteins: 2.7,fats: 0.7,carbohydrates: 1.3,calories100g: 20,onePortionG: 0, isMain:true,types:'о,y'},
        {id: 27,name: 'Соль поваренная',proteins: 0,fats: 0,carbohydrates: 0,calories100g: 0,onePortionG: 0, isMain:true,types:'з,о,y,п'},
        {id: 28,name: 'Лук репчатый',proteins: 2,fats: 0,carbohydrates: 9,calories100g: 45,onePortionG: 15, isMain:true,types:'з,о,y,п'},
        {id: 29,name: 'Чеснок',proteins: 0,fats: 0,carbohydrates: 0,calories100g: 0,onePortionG: 15, isMain:true,types:'з,о,y,п'},
