...
export const inner_param: IParams = {
    ...
    products: [
        ...
        {id: 28,name: 'Лук репчатый',proteins: 2,fats: 0,carbohydrates: 9,calories100g: 45,onePortionG: 15, isMain:true,types:'з,о,у,п'},
        {id: 29,name: 'Чеснок',proteins: 0,fats: 0,carbohydrates: 0,calories100g: 0,onePortionG: 15, isMain:true,types:'з,о,у,п'},
